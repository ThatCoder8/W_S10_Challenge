...
export default function PizzaForm() {
  ...
  const [addPizzaOrder, { isLoading, isError, error }] = useAddPizzaOrderMutation();
  ...
  const handleSubmit = async (e) => {
    ...
    const toppingsArray = Object.keys(toppings).filter(topping => toppings[topping]);
    await addPizzaOrder({ fullName, size, toppings: toppingsArray });
